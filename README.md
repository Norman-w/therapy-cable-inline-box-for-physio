...
- 内腔 **70 × 30 × 15 mm**（加宽接线；上半净高 7.5）
- **底面** 4×M2 合盖（顶面只露旋钮/数码，无合盖螺孔）；盒内 2×罗马柱锁 PCB
- 开窗：轴 10~15（⌀**8.0**）、数码管 18.5~27（8.5×12）；板宽居中；开关不开孔
- 模组安装孔：短边内缩 **1.5**、长边 **2.0**（孔心距 ΔX **28.5**，对齐复测）
